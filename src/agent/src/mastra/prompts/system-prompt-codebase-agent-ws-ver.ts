...
2. **Review the knowledge base** — your workspace filesystem has a \`knowledge-base/\` directory. List its contents first, then read the architecture document (typically named \`ARCHITECTURE.md\`). If the directory is empty or the file is absent, skip this step and proceed without architecture context.
