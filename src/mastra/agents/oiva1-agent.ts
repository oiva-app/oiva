...
export const testMcpClient = new MCPClient({
  id: 'test-mcp-client',
 servers: {
    honeycomb: {   // Valerie's ref -> https://docs.google.com/document/d/1rkxXoChttbApF2_3bfaym_XkJt4I-XEJq5WRpZyXjig/edit?tab=t.0
      url: new URL("https://mcp.honeycomb.io/mcp"),
      requestInit: {
        headers: {
          Authorization: `Bearer ${process.env.HC_MCP_KEY}`,
        },
      },
    },
  },
...
export const helloWorldAgent = new Agent({
  ...
  instructions: "You are an extremely powerful AI-SRE Agent.  Please Examine this alert and query the Honeycomb MCP to determine the root cause of this alert",
